...
export default {
  ...
  props: {
    ...
    horizontalFactorInput: {type: Number, default: 1.6},  // (CANNOT BE BELOW 1) Increase factor in gaps between horizontal lines

    // Geometry props - Vertical lines
    amountVerticals: {type: Number, default: 6},  // Amount of vertical lines
    verticalAngleFactorInput: {type: Number, default: 1.6},  // (CANNOT BE BELOW 1) Increase factor in Angle gaps between vertical lines
  ...
  beforeMount() {
    this.horizontalFactor = this.horizontalFactorInput;
    if (this.horizontalFactorInput < 1) {this.horizontalFactor = 1;}

    this.verticalAngleFactor = this.verticalAngleFactorInput;
    if (this.verticalAngleFactorInput < 1) {this.verticalAngleFactor = 1;}
